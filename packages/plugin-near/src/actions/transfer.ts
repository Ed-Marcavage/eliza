 ...
 * Inherits from Content interface.
 * @interface
 */
 ...
 * @param {any} content - The content to check if it is a TransferContent object.
...
/**
 * Transfer NEAR tokens from current account to the given recipient.
