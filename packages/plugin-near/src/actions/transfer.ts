...
/**
 * Function to check if the provided content is TransferContent type.
 * @param {IAgentRuntime} runtime - The runtime object.
 * @param {any} content - The content to be checked.
 * @returns {boolean} Returns true if the content is TransferContent type, false otherwise.
 */
 ...
 * @param {string} amount - The amount of NEAR tokens to transfer in NEAR token format (e.g. "10 NEAR").
