...
/**
 * Interface for deploying a token with specific content
...
/**
 * Check if the given object conforms to the structure of a DeployTokenContent.
 * 
 * @param {DeployTokenContent} content - The object to be checked
